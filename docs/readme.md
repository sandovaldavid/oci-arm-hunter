...
All configuration lives in `.env` (generated by `make setup`). See [`.env.example`](https://github.com/sandovaldavid/oci-arm-hunter/blob/main/.env.example) for all available variables.
...
See [CONTRIBUTING.md](https://github.com/sandovaldavid/oci-arm-hunter/blob/main/CONTRIBUTING.md) for the branch strategy, commit format, and PR process.

All commits must follow [Conventional Commits](https://www.conventionalcommits.org/). Scope is required — see [CLAUDE.md](https://github.com/sandovaldavid/oci-arm-hunter/blob/main/CLAUDE.md) for the project scope table.

---

## License

[MIT](https://github.com/sandovaldavid/oci-arm-hunter/blob/main/LICENSE) — David Sandoval, 2026
